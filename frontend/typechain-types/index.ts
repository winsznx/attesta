...
export type { AttestaCertificate } from "./contracts/AttestaCertificate";
export { AttestaCertificate__factory } from "./factories/contracts/AttestaCertificate__factory";
